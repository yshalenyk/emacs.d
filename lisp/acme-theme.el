...
(let* ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   ;; generic stuff
   `(default ((t (:background ,bg :foreground ,fg :family "Pragmata Pro" :box (:line-width 1 :color ,bg)))))
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground ,fg :slant oblique :weight light :family "Iosevka" :box nil))))
   `(font-lock-comment-face ((t (:foreground ,fg :slant oblique :weight light :family "Iosevka" :box nil))))
   `(font-lock-constant-face ((t (:foreground ,fg))))
   `(font-lock-doc-face ((t (:foreground ,fg :weight light :family "Iosevka" :box nil))))
   ...
   `(font-lock-string-face ((t (:foreground ,fg-medium :family "Iosevka Slab" :box nil))))
